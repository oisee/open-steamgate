...
//
// The APC framework is the library's (abap.APCChannel, go/abap/apc.go)
...
// apcHost is ZCL_APC_HOST as the library's abap.APCHost
...
func Channel(app, handler string) *abap.APCChannel {
	return &abap.APCChannel{Name: app, New: func(s *abap.Session, r *http.Request) abap.APCHost {
