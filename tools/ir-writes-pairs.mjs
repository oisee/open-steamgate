...
export const R_CASES = [
  ...
  {name: "INSERT a lower-case text: the prefix ends at once (measured: 12ab gives 12000000, ANOMALY-2026-09-24-raw-columns)", stmt: () => insertRows("R", R_COLS, rrow({mandt: "001", id: 7, r: "12ab"}))},
