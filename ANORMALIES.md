...
- Status: `workaround` for the table only. **ZC_OSD_TAXICUBE does not deploy to a system yet**: its element `Zone` is refused too, until it is renamed (`PickupZone`, the PR stacked on this one)
