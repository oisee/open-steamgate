...
- Minimal ABAP reproducer: `docs/probes/httpc/zcl_osg_httpc_body.testclasses.abap`, `zcl_osg_httpc_body2.testclasses.abap`, `zcl_osg_httpc_cs.testclasses.abap` (over `zcl_osg_httpc_probe.clas.abap` and `zosg_httpc_sleep.func.abap`); on Node, case `post-nonlatin` of `tools/gogen/httpc.mjs` (spike/go-backend)
...
- Minimal ABAP reproducer: `docs/probes/httpc/zcl_osg_httpc_misc.testclasses.abap`, methods `f1`-`f7`; on Node, cases `refused`, `tls-to-plain`, `bad-scheme`, `header-newline` of `tools/gogen/httpc.mjs` (spike/go-backend)
...
- Minimal ABAP reproducer: `docs/probes/httpc/zcl_osg_httpc_time.testclasses.abap`, methods `t0`-`t5`
...
- Minimal ABAP reproducer: `docs/probes/httpc/zcl_osg_httpc_misc.testclasses.abap`, methods `s1`-`s4` (every probe call prints `get_status( )`, the three fields and the names of all `~` fields); on Node, case `status-500` of `tools/gogen/httpc.mjs` (spike/go-backend)
...
- Minimal ABAP reproducer: `docs/probes/httpc/zcl_osg_httpc_misc.testclasses.abap`, methods `q1`-`q4`, and `zcl_osg_httpc_time.testclasses.abap`, method `q5`; on Node, case `query-post` of `tools/gogen/httpc.mjs` (spike/go-backend)
