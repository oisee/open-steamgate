...
CLASS ltcl_media IMPLEMENTATION.
  ...
  METHOD the_show_is_there.
    ...
    zcl_zosd_011_lsd_media=>load( EXPORTING iv_name = 'ZOSD_011_SHOW' IMPORTING ev_data = lv_data ev_size = lv_size ).
  ...
  METHOD an_unknown_object_is_empty.
    DATA: lv_data TYPE xstring, lv_size TYPE i.
    zcl_zosd_011_lsd_media=>load( EXPORTING iv_name = 'ZOSD_011_NOTHING' IMPORTING ev_data = lv_data ev_size = lv_size ).
